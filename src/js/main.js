                ...
                <div style="max-width: 1200px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; gap: 20px;">
                    ...
                    <div style="flex: 1; display: flex; gap: 16px; align-items: center;">
                        ...
                        <div style="color: white; font-size: 13px; line-height: 1.4;">
                            <div style="font-weight: bold; margin-bottom: 3px; font-size: 16px; color: #D4AF37;">1日あたり約194円</div>
                            <div style="font-weight: bold; margin-bottom: 6px;">愛犬の人生が変わる</div>
                            <div style="font-weight: bold; margin-bottom: 3px; text-decoration: line-through; opacity: 0.6;">¥7,260</div>
                            <div style="font-weight: bold; margin-bottom: 3px; font-size: 15px; color: #F44E5C;">¥5,808 初回20%OFF</div>
